...
<div class="col-12 col-lg-6" style="padding:1pc;margin:auto">
	<center>
		<?php
...
<header id="header">
	<nav class="col-lg-12 border-bottom">
		<div class="row">
			<div class='col-sm py-3'>
				<center>
					<form class="col-lg-5" method="post" style="display:none">
						<input name='recherche' class="py-0 border rounded my-0 btn" placeholder="Recherche un produit"/>
						<button class="btn py-0 border">OK</button>
					</form>
				</center>
			</div>
		</div>
